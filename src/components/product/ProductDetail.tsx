    ...
    return (
        <div className="productDetail">
            ...
            <div className="detail">
                <h1>{product?.title} ({product?.color})</h1>
                <hr style={{ margin: '10px 0' }} />
                <span>Rating: {product?.rating} | Price: ₹{product?.price}/- | Brand: New brand | Exchangable: Yes</span>
                <hr style={{ margin: '10px 0' }} />

                <h4><MdArrowRight style={{ margin: '0 0 -2px 0' }} />Cash on Delivery <IoIosCheckmarkCircle style={{ margin: '0 0 -2px 0' }} color='rgb(7, 135, 92)' /> </h4>
                <hr style={{ margin: '10px 0' }} />

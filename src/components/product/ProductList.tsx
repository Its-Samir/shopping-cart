...
function ProductList() {
  ...
  const [isLoggedIn, setIsLoggedIn] = useState<boolean>(
    ctx.isLoggedIn && JSON.parse(localStorage.getItem("loggedin") as string)
  );
    ...
    <>
      ...
      <Box sx={{ textAlign: "center", margin: "2rem" }}>
        ...
        <p style={{ color: "grayText" }}>
          ...
          quia a sapiente quasi aliquam nobis error ad ullam doloribus iusto.
        </p>
        <Button
          onClick={() => navigate(ctx.isLoggedIn ? "/cart" : "/auth")}
          variant="contained"
          children={ctx.isLoggedIn ? "Shop now" : "Login"}
          color="warning"
